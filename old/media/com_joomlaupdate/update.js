...
function processUpdateStep(data)
{
	...
	else
	{
		...
		else
		{
			...
			// Display data
			document.getElementById('extpercent').innerHTML = Number(joomlaupdate_stat_percent).formatPercentage(1);
			document.getElementById('extbytesin').innerHTML = Number(joomlaupdate_stat_inbytes).format();
			document.getElementById('extbytesout').innerHTML = Number(joomlaupdate_stat_outbytes).format();
			document.getElementById('extfiles').innerHTML = Number(joomlaupdate_stat_files).format();
